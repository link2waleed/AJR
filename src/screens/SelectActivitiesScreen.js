...
const SelectActivitiesScreen = ({ navigation, route }) => {
    ...
    const handleContinue = async () => {
        ...
        try {
            ...
            // Navigate to activity setup flow based on selections
            if (selections.prayers === 'yes') {
                navigation.navigate('PrayerSetup', { activities: selections, fromSettings });
            } else if (selections.quran === 'yes') {
                navigation.navigate('QuranGoal', { activities: selections, fromSettings });
            } else if (selections.dhikr === 'yes') {
